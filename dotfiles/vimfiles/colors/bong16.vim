...
highlight Identifier term=none cterm=none ctermfg=red ctermbg=none gui=none guifg=#87dfff
...
highlight Conditional term=none ctermfg=green ctermbg=none gui=none guifg=#ef7f00
highlight Repeat term=none ctermfg=yellow ctermbg=none gui=none guifg=#5fdf00
highlight Label term=none ctermfg=yellow ctermbg=none gui=none guifg=#5fdf00
...
highlight Type term=none ctermfg=green ctermbg=none gui=none guifg=#ff9fff
...
highlight Visual ctermfg=black ctermbg=darkmagenta cterm=none
...
highlight Folded term=none ctermfg=darkgray ctermbg=none guifg=#9e9e9e guibg=#262626
highlight FoldColumn term=none ctermfg=yellow ctermbg=darkblue guifg=#9e9e9e guibg=#262626
highlight SignColumn term=none ctermfg=247 ctermbg=235 guifg=#9e9e9e guibg=#262626
highlight SpecialKey term=underline ctermfg=darkmagenta gui=none guifg=darkgray
highlight NonText term=none ctermfg=darkmagenta gui=none guifg=black
...
if version >= 700
  ...
  highlight LineNr term=none ctermfg=blue ctermbg=none guifg=#5f5f00 guibg=bg
  highlight MatchParen ctermfg=none ctermbg=darkcyan guibg=#4e4e4e
  highlight Pmenu ctermfg=white ctermbg=darkblue gui=none guifg=#121212 guibg=#b2b2b2
  highlight PmenuSel ctermfg=yellow ctermbg=darkcyan gui=none guifg=#121212 guibg=#666666
